...
import EnclaveProject from './Pages/enclaveProject';
import ResidencyProject from './Pages/residencyProject';
            ...
            <BrowserRouter basename="/">
                ...
                <div className="page-wraper">
                        <Routes>
                            ...
                            <Route path='/nsv-residency' element={<ResidencyProject/>} />
                            <Route path='/nsv-enclave' element={<EnclaveProject/>} />
